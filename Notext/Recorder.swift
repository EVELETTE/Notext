...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.evecorp.notext", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "com.evecorp.notext.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "com.evecorp.notext.audioSetup", qos: .userInitiated)
