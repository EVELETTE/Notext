...
class AudioTranscriptionManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.evecorp.notext", category: "AudioTranscriptionManager")
    ...
    func startProcessing(modelContext: ModelContext, engine: NotextEngine) {
    ...
    private func processItem(_ item: AudioFileQueueItem, modelContext: ModelContext, engine: NotextEngine) async {
