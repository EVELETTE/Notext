...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.evecorp.notext", category: "LogExporter")
    private let subsystem = "com.evecorp.notext"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== Notext Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "Notext_Logs_\(timestamp).log"
