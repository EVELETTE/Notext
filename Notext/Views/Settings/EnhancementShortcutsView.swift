        ...
        VStack(spacing: 8) {
            ...
            HStack(alignment: .center, spacing: 12) {
                HStack(spacing: 4) {
                    ...
                    InfoTip(
                        "Quickly enable or disable AI enhancement while recording. Available only when Notext is running and the recorder is visible.",
            ...
            HStack(alignment: .center, spacing: 12) {
                HStack(spacing: 4) {
                    ...
                    InfoTip(
                        "Switch between your saved prompts using ⌘1 through ⌘0 to activate the corresponding prompt in the order they are saved. Available only when Notext is running and the recorder is visible.",
                        learnMoreURL: "https://tryvoiceink.com/docs/enhancement-shortcuts"
                    )
                }
