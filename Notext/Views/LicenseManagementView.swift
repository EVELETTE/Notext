            ...
            VStack(spacing: 16) {
                HStack(spacing: 16) {
                    ...
                    HStack(alignment: .lastTextBaseline, spacing: 8) {
                        Text(licenseViewModel.licenseState == .licensed ? "Notext Pro" : "Upgrade to Pro")
                ...
                Text(licenseViewModel.licenseState == .licensed ?
                     "Thank you for supporting Notext" :
        ...
        VStack(spacing: 32) {
            ...
            VStack(spacing: 24) {
                ...
                if licenseViewModel.activationsLimit > 0 {
                    ...
                    Text("You can use Notext Pro on all your personal devices")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                }
            }
