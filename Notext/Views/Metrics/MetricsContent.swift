...
struct MetricsContent: View {
    private let logger = Logger(subsystem: "com.evecorp.Notext", category: "MetricsContent")
    ...
    private var metricsSection: some View {
        LazyVGrid(columns: [GridItem(.adaptive(minimum: 240), spacing: 16)], spacing: 16) {
            MetricCard(
                ...
                value: "\(totalCount)",
                detail: "Notext sessions completed",
                color: .purple
            )
            ...
            MetricCard(
                ...
                value: averageWordsPerMinute > 0
                    ...
                    : "–",
                detail: "Notext vs. typing by hand",
                color: .yellow
            )
    ...
    private var heroSubtitle: String {
        guard totalCount > 0 else {
            return "Your Notext journey starts with your first recording."
        }
