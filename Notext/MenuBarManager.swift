...
class MenuBarManager: ObservableObject {
    private let logger = Logger(subsystem: "com.evecorp.notext", category: "MenuBarManager")
    ...
    private var engine: NotextEngine?
    ...
    func configure(modelContainer: ModelContainer, engine: NotextEngine) {
